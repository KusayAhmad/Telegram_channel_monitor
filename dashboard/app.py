"""
لوحة تحكم Flask للمشروع
واجهة ويب لإدارة نظام المراقبة
"""
import asyncio
...
class User(UserMixin):
    """مستخدم وهمي للمصادقة"""
    def __init__(self, id):
        self.id = id


# مستخدم افتراضي (يمكن تحسينه لاحقاً)
ADMIN_USER = User(1)
...
def run_dashboard():
    """تشغيل لوحة التحكم"""
    monitor_logger.info(f"🌐 تشغيل لوحة التحكم على http://{config.DASHBOARD_HOST}:{config.DASHBOARD_PORT}")
    app.run(
